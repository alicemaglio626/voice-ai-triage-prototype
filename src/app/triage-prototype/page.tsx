...
function TriageTab() {
  ...
  return (
    <>
      ...
      <Table className="min-w-[880px] [&_td]:whitespace-nowrap [&_td]:px-4 [&_th]:whitespace-nowrap [&_th]:px-4">
        <TableHeader>
          <TableRow>
            <TableHead>Phone number</TableHead>
            <TableHead>Call ID</TableHead>
            <TableHead>AI mistake type</TableHead>
            <TableHead>Provider frustrated</TableHead>
          ...
          {paged.length === 0 ? (
            ...
            paged.map((r) => (
              ...
              >
                ...
                <TableCell className="text-sm">{r.callType}</TableCell>
...
function DisagreementsTab() {
  ...
  return (
    <>
      <p className="flex max-w-3xl items-center gap-1.5 text-sm text-muted-foreground">
      ...
      <Table className="min-w-[860px] [&_td]:whitespace-nowrap [&_td]:px-4 [&_th]:whitespace-nowrap [&_th]:px-4">
        <TableHeader>
          <TableRow>
            <TableHead>Phone number</TableHead>
            <TableHead>Call ID</TableHead>
